...
FindInFilesDetails = collections.namedtuple("FindInFilesDetails", "find path regexp")
...
class FindInFilesDialog(wx.Dialog):
    ...
    def GetDetails(self):
        return FindInFilesDetails(self.find, self.path, self.check_regexp.GetValue())
